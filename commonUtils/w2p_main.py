...
if __name__ == "__main__":
    # 获取当前运行路径
    # path = os.getcwd()
    word2pdf('D:\\software\\PyCharm 2019.3.2\\PythonProjects\\learn-python\\commonUtils\\input',
             'D:\\software\\PyCharm 2019.3.2\\PythonProjects\\learn-python\\commonUtils\\output')
